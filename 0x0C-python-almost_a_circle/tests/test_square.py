...
class TestSquareMethods(unittest.TestCase):
    """ Test suites for Square class """

    def setUp(self):
        """ Method invoked for tests"""
        Base._Base__nb_objects = 0

    def test_new_square_one(self):
        new = Square(3)
    ...
    def test_new_square_three(self):
        new = Square(1, 1)
        new2 = Square(1, 1)
    ...
    def test_incorrect_attrs_one(self):
        with self.assertRaises(TypeError):
            new = Square()

    def test_incorrect_attrs_two(self):
        with self.assertRaises(TypeError):
            new = Square(1, 1, 1, 1, 1)

    def test_getattrs_width(self):
        new = Square(1)
        with self.assertRaises(AttributeError):
            new.__width

    def test_getattrs_height(self):
        new = Square(1)
        with self.assertRaises(AttributeError):
            new.__height

    def test_getattrs_x(self):
        new = Square(1)
        with self.assertRaises(AttributeError):
            new.__x

    def test_getattrs_y(self):
        new = Square(1)
        with self.assertRaises(AttributeError):
            new.__y

    def test_valid_attrs_one(self):
        with self.assertRaises(TypeError):
            new = Square("2", 2, 2, 2)

    def test_valid_attrs_two(self):
        with self.assertRaises(TypeError):
            new = Square(2, "2", 2, 2)

    def test_valid_attrs_three(self):
        with self.assertRaises(TypeError):
            new = Square(2, 2, "2", 2)

    def test_value_attrs_one(self):
        with self.assertRaises(ValueError):
            new = Square(0)

    def test_value_attrs_two(self):
        with self.assertRaises(ValueError):
            new = Square(1, -1)

    def test_value_attrs_three(self):
        with self.assertRaises(ValueError):
            new = Square(1, 1, -1)
